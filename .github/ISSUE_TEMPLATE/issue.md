...
1. What is the type of this issue?
    - [ ] User
        ...
        - [ ] Functional: no longer able to satisfy use case due to newly incurred limitations.
        - [ ] Behavioral: something happened not expected.

        > Please limit issues to a single type.

    - [ ] Developer

        > Please include any and all links suspected of causing the issue.
