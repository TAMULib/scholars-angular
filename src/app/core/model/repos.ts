...
import { AnalyticViewRepo } from './view/repo/analytic-view.repo';
...
export const repos = {
  ...
  analyticViews: new InjectionToken<string>('AnalyticViewRepo'),
...
export const injectable = [
  ...
  { provide: repos.analyticViews, useExisting: AnalyticViewRepo },
